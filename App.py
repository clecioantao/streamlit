...
st.set_page_config(
    page_title='DASHBOARD DE VENDAS - ANUAIS',
    page_icon='💲',
    layout='wide',
    initial_sidebar_state='expanded',
    menu_items={
        'Get Help': 'http://www.clecio.com.br',
...
# Remover a coluna 'Data' se existir
if 'Data' in tab1_qtde_produto.columns:
...
# Remover a coluna 'Data' se existir
if 'Data' in tab3_Vendas_Vendedor.columns:
...
# Remover a coluna 'Data' se existir
if 'Data' in tab4_Venda_Cliente.columns:
